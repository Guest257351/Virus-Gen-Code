...
echo.
echo you are using a free installer.
echo any backdoors created will expire after 1 month or at the end of the year
echo you will still be able to use backdoors generated by paid users on the public repo
